...
\vref{sec:descricao-problema}. Ela é composta de 3 camadas distintas mas que se
...
\ref{fig:arquitetura-v3} representa graficamente a arquitetura proposta.

\figurasimples{arquitetura-v3}{Visão geral arquitetural da solução}{12cm}
