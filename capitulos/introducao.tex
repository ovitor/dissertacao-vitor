...
Vale ressaltar que este dispositivo é o resultado de um
projeto de pesquisa, do qual participei de forma efetiva, que recebeu fomento da 
Agência Nacional de Energia Elétrica (ANEEL), em parceria com a Empresa CRAFF, 
sediada no Município de Fortaleza.
...
contexto em que ele está inserido, como por exemplo, se ele está acamado
ou se possui certa autonomia, ou ainda, se o doente está acompanhado. 
Em seguida, os dados coletados são repassados ao STB que 
os concentra, realiza um processamento, e os repassa para o provedor de 
\textit{home care} (Estado ou empresa privada). Em determinados momentos, 
o sistema pode auxiliar os atores envolvidos, emitindo alertas por meio da 
televisão.

% não gosto dessa "comprovação de alguns conceitos"
