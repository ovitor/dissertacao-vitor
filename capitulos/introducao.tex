...
de morte.  % o aumento de casos em que o paciente pode ser tratado v

% Nesse sentido, este trabalho apresenta um sistema de informática baseado em
% Set-Top Box (STB) e sensores para auxiliar
